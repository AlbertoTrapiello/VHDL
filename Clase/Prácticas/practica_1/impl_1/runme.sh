...
HD_PWD='C:/Users/Alberto/Desktop/Universidad/Cuarto/SED/practica_1/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log p1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source p1.tcl -notrace
