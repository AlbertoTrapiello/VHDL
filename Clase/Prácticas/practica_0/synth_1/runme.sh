...
HD_PWD='C:/Users/Alberto/Desktop/Universidad/Cuarto/SED/practica_0/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log p1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source p1.tcl
