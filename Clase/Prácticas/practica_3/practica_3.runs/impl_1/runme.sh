...
HD_PWD='D:/Universidad/Cuarto/SED/practica_3/practica_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log parity_machine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source parity_machine.tcl -notrace
