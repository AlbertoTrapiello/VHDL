...
HD_PWD='D:/Universidad/Cuarto/SED/practica_3/practica_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parity_machine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parity_machine.tcl
