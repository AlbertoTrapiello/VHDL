...
set rc [catch {
  ...
  set_property webtalk.parent_dir D:/Universidad/Cuarto/SED/Learning/Learning/Learning.cache/wt [current_project]
  set_property parent.project_path D:/Universidad/Cuarto/SED/Learning/Learning/Learning.xpr [current_project]
  set_property ip_output_repo D:/Universidad/Cuarto/SED/Learning/Learning/Learning.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet D:/Universidad/Cuarto/SED/Learning/Learning/Learning.runs/synth_1/mux.dcp
  link_design -top mux -part xc7k70tfbv676-1
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file mux_timing_summary_routed.rpt -pb mux_timing_summary_routed.pb -rpx mux_timing_summary_routed.rpx -warn_on_violation "
  ...
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file mux_bus_skew_routed.rpt -pb mux_bus_skew_routed.pb -rpx mux_bus_skew_routed.rpx"
